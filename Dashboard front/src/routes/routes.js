...
const DetailedOperation = () => import( "src/pages/Dashboard/Pages/DetailedOperation.vue");
const CreateOperation = () => import( "src/pages/Dashboard/Pages/CreateOperation.vue");
const Pricing = () =>
  import(
...
const DefaultUserPageHeader = () => 
  import(
    "src/pages/Dashboard/DefaultUserPageHeader.vue"
  );
let componentsMenu = {
  path: "/components",
  ...
  children: [
    {
      path: "user",
      name: "User Page",
      components: { default: User, header: DefaultUserPageHeader }
    },
    {
      path: "operations/:operationId",
      name: "operationDetailed",
      components: { default: DetailedOperation, header: DefaultHeader}
    },
    {
      path: "createOperation",
      name: "Create Operation",
      components: {default: CreateOperation, header: DefaultHeader}
    },
    {
      path: "timeline",
      name: "Timeline Page",
